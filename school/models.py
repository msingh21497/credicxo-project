...
class User(AbstractBaseUser):
    ...
    delete_doc = models.FileField(upload_to="school/deletion/attachment/", max_length=700, blank=True)
...
from school.tokens import get_token_generator
...
class ResetPasswordToken(models.Model):
    ...
    user = models.ForeignKey(
        AUTH_USER_MODEL,
        related_name='get_password_reset_tokens',
